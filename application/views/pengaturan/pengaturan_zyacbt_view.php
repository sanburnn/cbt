...
<section class="content-header">
	<h1>
		Pengaturan ARR CBT
		<small>Melakukan pengaturan Identitas ARR CBT</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan ARR CBT</li>
	</ol>
</section>
			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Daftar Pengaturan ARR CBT</div>
                    </div><!-- /.box-header -->
